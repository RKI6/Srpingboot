...
public class Children {
    ...
    public Children(int babyld, String babyFirstName, String babyLastName, String fatherName, String motherName,
            String address) {
        this.babyld = babyld;
    ...
    public int getBabyld() {
        return babyld;
    }
    public void setBabyld(int babyld) {
        this.babyld = babyld;
    }
